...
class Product{
  ...
  productPrice(){
    return cents_to_dollars(this.priceCents);
  }
}
...
export let product;
export function load_products_from_backend(func){
  const xhr = new XMLHttpRequest();

  xhr.addEventListener('load', () => {
    product = JSON.parse(xhr.response).map((item) =>{
...
// console.log(load_products_from_backend());
